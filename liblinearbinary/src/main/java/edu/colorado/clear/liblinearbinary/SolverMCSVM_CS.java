...
import static edu.colorado.clear.liblinearbinary.Linear.copyOf;
import static edu.colorado.clear.liblinearbinary.Linear.info;
import static edu.colorado.clear.liblinearbinary.Linear.swap;
            ...
            for (s = 0; s < active_size; s++) {
                ...
                if (Ai > 0) {
                    ...
                    for (int xi : prob.x[i]) {
                        ...
                        int w_offset = (xi - 1) * nr_class;
                        for (m = 0; m < active_size_i[i]; m++)
                            // G[m] += w_i[alpha_index_i[m]]*(xi.value);
                            G[m] += w[w_offset + alpha_index_i.get(m)];
