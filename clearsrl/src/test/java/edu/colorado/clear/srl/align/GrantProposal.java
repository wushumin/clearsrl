...
public class GrantProposal {
    ...
    {   
        ...
        Map<String, TBTree[]> treeBank = TBUtil.readTBDir("/home/shumin/corpora/ontonotes-release-4.0/data/english/annotations", "(chtb_0)\\d{3}\\.parse\\z");
        
        Map<String, SortedMap<Long, String>> idMap = readVerbNetId(args[2], treeBank);
