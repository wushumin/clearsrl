...
public class HungarianAlgorithm {
    ...
    /**
     * @param matrix square matrix representing the cost of r_i assigned to c_j
     * @return 2-column matrix, column 1 contains the row id, column 2 contains 
     *         the (sorted) column id of the input matrix that will result the
     *         least sum
     */
    ...
    {
        float [][] matrix1 = {{0.1f, 0.2f,0.8f},{0.3f,0.6f,0.5f},{0.9f,0.1f, 0.2f}};
        int[][] retval = HungarianAlgorithm.computeAssignments(matrix1);
